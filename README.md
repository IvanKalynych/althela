...
3. ADMIN у адмін-панелі:
   ...
   b. Обирає тип контракту (впливає на логіку оплати при бронюванні):
      ...
      - Тип 2: Часткова передоплата (частина з кредитів, частина доплачує клієнт, 50|50)
      - Тип 3: Постоплата (компанія отримує при заключенні договору дисконт 10%, оголошує працівникам що вони можуть реєструватись на платформі за кодом договору і матимуть дисконт на кожну сесію на будь якого консультанта, але 90% платить самостійно співробітник)
...
CORPORATE CLIENT → Обирає терапевта → Обирає вид консультації (відео / чат)
  ...
  [Тип 1 — 100% передоплата]:
    ...
    → [ENOUGH CREDITS] → Кредити списуються після бронювання, бо ми працюємо по передплаті, сесія може не відбутись взагалі, але якщо воне не відбулась бо клієнт не з"явився гроші не повертаються.
